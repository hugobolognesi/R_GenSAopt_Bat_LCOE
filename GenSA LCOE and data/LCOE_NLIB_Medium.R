...
LCOE_NLIB_Medium <- function(x) {
  ...
  ### Para testar ###
#  Q_pv <- 588 # Quantidade de painéis instalados - Variável para otimização
...
#  Dem_TDC_p <- Dem_TDC_fp # Demanda contratada na ponta em kW - variável móvel para o mínimo
#  Dem_TDG <- 254 # Demanda contratada de geração em kW - variável móvel para o mínimo
#  REC <- 0.8 # Porcentagem do SoH que pode recarregar com energia da rede em horário fp
