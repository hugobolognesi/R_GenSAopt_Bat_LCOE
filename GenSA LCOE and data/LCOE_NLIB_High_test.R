  ...
  Q_pv <- 637 # Quantidade de painéis instalados - Variável para otimização
  Q_mod <- 225 # Quantidade de baterias novas instaladas - Variável para otimização
  ...
  Dem_TDG <- 197 # Demanda contratada de geração em kW - variável móvel para o mínimo
  ...
  Tb_custos <- data.frame(T_yrl[, 1], CAPEX_pv, CAPEX_bat, C_OM_pv, C_OM_bat, #Custos de equipamentos
                          C_energy_in, C_energy_out, C_pen,  #Custos variávei
