...
LCOE_BAU_High <- function(x) {
  ...
  Dem_TDC_fp <- x[1] # Demanda contratada fora ponta em kW - variável móvel para o mínimo
  Dem_TDC_p <- x[2] # Demanda contratada na ponta em kW - variável móvel para o mínimo
