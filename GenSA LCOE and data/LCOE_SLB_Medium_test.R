  ...
  ### Para testar ###
    Q_pv <- 598 # Quantidade de painéis instalados - Variável para otimização
    Q_mod <- 188 # Quantidade de baterias novas instaladas - Variável para otimização
...
#  C_DEM_p[1] <- 0
  ...
  Emi_pv <- 749.8/1000 #Emissoes de CO2 em kg CO2eq/Wp instalado
